...
# class MobileNetPartial(nn.Module):
#     supported_layers = ['']
#
#     def __init__(self,
#                  architecture,
...
#                  data_parallel=False,
#                  **kwargs):
#         super(MobileNetPartial, self).__init__()
...
def extract_features_to_disk(image_paths,
    ...
    if sys.version_info >= (3, 0):
        ...
        print('this is only for python3')
